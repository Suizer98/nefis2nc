...
# if os.path.exists(output_trih_file):
...
# else:
#     print("Trih output does not exist. Skipping the requests.")

# if os.path.exists(output_trim_file):
...
# else:
#     print("Trim output does not exist. Skipping the requests.")
