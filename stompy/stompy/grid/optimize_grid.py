...
class OptimizeGui(object):
    ...
    def run(self):
        ...
        self.cid_mouse = self.fig.canvas.mpl_connect(
            "button_release_event", self.on_buttonrelease
        )
...
class GridOptimizer(object):
    ...
    def update_apollonius_field(self):
        ...
        self.p.density = field.BinopField(self.original_density, minimum, self.apollo)
    ...
    def repave_neighborhood(
        ...
        # internal guide edge
        to_remove = (p.edges[edges_to_kill, 4] >= 0) & (
            p.edge_data[edges_to_kill, 1] < 0
        )
...
if __name__ == "__main__":
    p = paver.Paving.load_complete(
        "/home/rusty/classes/research/suntans/grids/fullbay-0610/final.pav"
    )
    p.clean_unpaved()
